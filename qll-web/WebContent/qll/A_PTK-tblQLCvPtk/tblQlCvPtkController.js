						...
						columns : [
							...
							},
							{
								...
								template : '<div class="text-center "> '
									...
									+'		<button style=" border: none; " class="icon_table" aria-hidden="true" ng-show="RoleMenu.checkRole.checkTPPTP&&(dataItem.tinh!=null||dataItem.cnkv!=null)"  uib-tooltip="Gán PXK cho nhân viên" translate>'
